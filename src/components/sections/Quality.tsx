  ...
  return (
    <section className="py-24 bg-slate-50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-20">
          {[
            ...
            <motion.div
              ...
              className="text-center p-6 bg-white shadow-xl rounded-2xl border border-black/5"
            >
        ...
        <div className="max-w-4xl mx-auto bg-white shadow-2xl rounded-3xl p-8 md:p-12 border border-black/5 relative overflow-hidden group">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="w-full md:w-1/2 aspect-square relative flex items-center justify-center">
              <div className="absolute inset-0 border border-black/10 rounded-full border-dashed animate-[spin_20s_linear_infinite]"></div>
              <div className="absolute inset-8 border border-accent/20 rounded-full animate-[spin_15s_linear_infinite_reverse]"></div>
              
              <div className="relative w-48 h-48 bg-white/80 backdrop-blur-md border border-black/5 shadow-inner rounded-2xl flex items-center justify-center overflow-hidden">
                {/* Scanning line */}
                <motion.div 
                  animate={{ y: ["-100%", "200%"] }}
                ...
                <div className="w-3/4 h-3/4 border-2 border-black/10 rounded-lg relative z-10">
